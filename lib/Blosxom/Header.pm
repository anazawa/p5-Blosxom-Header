...
sub push_p3p    { __PACKAGE__->instance->push_p3p_tags( @_ ) }
sub push_cookie { __PACKAGE__->instance->push_cookie( @_ )   }
...
sub instance {
    ...
    unless ( $class->is_initialized ) {
        croak( q{$blosxom::header hasn't been initialized yet} );
    }

    $instance = Blosxom::Header::Target->new( $blosxom::header );
}
